...
const LIVE_POOL_ADMIN_COMMAND_ROUTES: &[(LivePoolAdminCommand, &str, &str)] = &[
    ...
    (LivePoolAdminCommand::PoolRepair, "pool", "repair"),
...
mod tests {
    ...
    #[test]
    fn live_pool_admin_device_rebuild_route_is_typed() {
        let command = LivePoolAdminCommand::from_parts("device", "rebuild")
            .expect("device rebuild has a typed live-owner route");
        assert_eq!(command, LivePoolAdminCommand::DeviceRebuild);
        assert_eq!(command.parts(), ("device", "rebuild"));
    }
    ...
    #[test]
    fn live_pool_admin_pool_repair_route_is_typed() {
        let command = LivePoolAdminCommand::from_parts("pool", "repair")
            .expect("pool repair has a typed live-owner route");
        assert_eq!(command, LivePoolAdminCommand::PoolRepair);
        assert_eq!(command.parts(), ("pool", "repair"));
    }
