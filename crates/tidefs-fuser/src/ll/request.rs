...
///
/// Review debt TFR-011: document lock lifecycle and file-locking implementation.
///
...
pub struct Lock {
    ...
    pub range: (u64, u64),
    // Review debt TFR-011: make typ an enum.
    pub typ: i32,
    pub pid: u32,
}
impl Lock {
...
mod op {
    ...
    impl<'a> SetAttr<'a> {
        ...
        // Review debt TFR-011: document why setattr expects an attr response.
    }
    ...
    impl<'a> Write<'a> {
        ...
        /// is disabled
        ///
        /// Review debt TFR-011: add a WriteFlags type or remove this.
        ...
        /// Review debt TFR-011: make a Flags type specifying valid values.
        pub fn flags(&self) -> i32 {
            #[cfg(feature = "abi-7-9")]
    ...
    impl<'a> Release<'a> {
        ...
        /// Review debt TFR-011: document valid flags or remove this.
        pub fn flags(&self) -> i32 {
            self.arg.flags
        }
        pub fn lock_owner(&self) -> Option<LockOwner> {
    ...
    impl<'a> SetXAttr<'a> {
        ...
        // Review debt TFR-011: document valid flags.
        pub fn flags(&self) -> i32 {
            self.arg.flags
        }
    ...
    ///
    /// Review debt TFR-011: document standard conforming directory streams.
    #[derive(Debug)]
    ...
    impl<'a> ReleaseDir<'a> {
        ...
        /// Review debt TFR-011: document valid values.
        pub fn flags(&self) -> i32 {
            self.arg.flags
        }
    }
    ...
    impl<'a> IoCtl<'a> {
        ...
        /// Review debt TFR-011: document ioctl command semantics.
    ...
    /// Review debt TFR-011: merge BatchForget with Forget.
    ...
    impl<'a> BatchForget<'a> {
        /// Review debt TFR-011: hide fuse_forget_one behind a private type.
    ...
    /// Read directory.
    ///
    /// Review debt TFR-011: document when this is called rather than ReadDirectory.
    #[cfg(feature = "abi-7-21")]
    #[derive(Debug)]
    ...
    /// Rename a file.
    ///
    /// Review debt TFR-011: document differences from [Rename] and [Exchange].
    #[cfg(feature = "abi-7-23")]
    #[derive(Debug)]
    ...
    impl<'a> Rename2<'a> {
        ...
        ///
        /// Review debt TFR-011: replace with enum/flags type.
        pub fn flags(&self) -> u32 {
            self.arg.flags
        }
    }
    ...
    ///
    /// Review debt TFR-011: document when this is needed despite read/write offsets.
    ...
    impl<'a> Lseek<'a> {
        ...
        /// Review debt TFR-011: make this return an enum.
    ...
    impl<'a> CopyFileRange<'a> {
        ...
        // Review debt TFR-011: return a specific flags type.
    ...
    // Review debt TFR-011: consider rename2(RENAME_EXCHANGE).
    #[derive(Debug)]
    ...
    /// Review debt TFR-005: document timestamp conversion semantics.
