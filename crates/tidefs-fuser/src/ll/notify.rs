...
mod test {
    ...
    #[cfg(feature = "abi-7-18")]
    fn delete() {
        let n = Notification::new_delete(0x42, 0x1337, OsStr::new("abc"))
            .unwrap()
        ...
        let expected = vec![
            ...
            0x00, 0x00, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x37, 0x13, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x61, 0x62,
            0x63, 0x00,
        ];
        assert_eq!(n, expected);
    }
