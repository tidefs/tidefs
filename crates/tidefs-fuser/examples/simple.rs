...
impl Filesystem for SimpleFS {
    ...
    fn mknod(
        ...
        {
            // Review debt TFR-013: simple example mknod support is incomplete.
        ...
        // Review debt TFR-011: implement FUSE entry/open flag reporting.
    ...
    fn statfs(&mut self, _req: &Request, _ino: u64, reply: ReplyStatfs) {
        ...
        // Review debt TFR-013: replace simple example statfs stub with real accounting.
        reply.statfs(
            10_000,
            10_000,
            10_000,
    ...
    fn create(
        ...
        // Review debt TFR-011: implement FUSE create flag reporting.
        reply.created(
            &Duration::new(0, 0),
            &attrs.into(),
            0,
