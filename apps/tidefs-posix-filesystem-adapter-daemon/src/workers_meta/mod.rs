...
use tidefs_types_vfs_core::{
    ...
    FATTR_SIZE as VFS_FATTR_SIZE, FATTR_UID as VFS_FATTR_UID, S_IFBLK, S_IFCHR, S_IFDIR, S_IFIFO,
    S_IFLNK, S_IFMT, S_IFREG, S_IFSOCK, S_ISGID as VFS_S_ISGID, S_ISUID as VFS_S_ISUID,
