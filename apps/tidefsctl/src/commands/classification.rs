...
pub(crate) const COMMAND_SURFACES: &[CommandSurface] = &[
    ...
    CommandSurface {
        path: "snapshot prune-scheduled policy",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "inspect live scheduled snapshot prune policy admission state",
    },
    CommandSurface {
        path: "snapshot prune-scheduled plan",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "inspect live scheduled snapshot prune dry-run plans",
    },
    CommandSurface {
        path: "snapshot prune-scheduled enable",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "admit destructive scheduled snapshot prune execution through live authority",
    },
    CommandSurface {
        path: "snapshot prune-scheduled disable",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "disable destructive scheduled snapshot prune execution through live authority",
    },
    CommandSurface {
        path: "snapshot prune-scheduled status",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "inspect live scheduled snapshot prune job status",
    },
    CommandSurface {
        path: "snapshot prune-scheduled refusals",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "inspect live scheduled snapshot prune refusal reasons",
    },
    CommandSurface {
        path: "snapshot prune-scheduled results",
        class: CommandClass::PublicOperator,
        routing: RoutingSemantics::LiveOwner,
        summary: "inspect live scheduled snapshot prune result summaries",
    },
    CommandSurface {
...
mod tests {
    ...
    fn imported_pool_commands_keep_live_owner_routing_classification() {
        for path in [
            ...
            "snapshot prune",
            "snapshot prune-scheduled policy",
            "snapshot prune-scheduled plan",
            "snapshot prune-scheduled enable",
