...
| `docs/design/end-to-end-checksum-architecture-g3-pillar.md` | Historical target input names `data -> compress -> encrypt -> checksum -> write` and reverse read order. | Ordering evidence only until current runtime paths implement it. |
