...
| `tidefs-snapshot-pruner` | [#834](https://github.com/tidefs/tidefs/issues/834) | product-code | 1949 | Authority established: 71 unit tests and 9 integration tests validate retention policies, BLAKE3 integrity gating, clone/origin protection, deadlist drain, and explicit destroy; zero reverse dependencies reflect service-boundary wiring, not placeholder; live daemon integration remains follow-up |
