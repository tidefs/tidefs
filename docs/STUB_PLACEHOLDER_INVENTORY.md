...
| `tidefs-geometry-convert` | [#824](https://github.com/tidefs/tidefs/issues/824) | product-code | 1348 | Authority established for the standalone conversion job contract: policy/cursor encoding, budgeted locator-walk progress, real BLAKE3 payload digests, and checkpointed fail-stop errors. Live pool/locator-table/EC runtime integration remains follow-up issue #1181. |
