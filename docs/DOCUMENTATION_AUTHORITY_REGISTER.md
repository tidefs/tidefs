...
| `docs/DEBUGGING_WORKFLOWS.md` | Deleted | Deleted by #1779 after #1725 merged and #1722 closed. Current entry-point commands live in `docs/GETTING_STARTED.md`; CI lane and artifact authority lives in `docs/GITHUB_CI.md`; xfstests scoreboard details live in `docs/xfstests-harness.md`; source-owned command help remains in the relevant binaries. |
