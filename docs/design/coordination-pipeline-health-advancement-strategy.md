...
| Transition | Trigger | Action |
|-----------|---------|--------|
| Healthy -> Degraded | 1+ issues blocked by dependencies | Document blockage in STATUS.md |
...
A conceptual "dashboard" view of the coordination pipeline, rendered as a
structured STATUS.md section or generated by the coordination health report
issue (#1728):
...
Phase 4: Production Integration
               all deferred production gates in
               CURRENT_VS_FUTURE_CAPABILITIES.md are resolved
  -> Pipeline complete
```
...
4. STATUS.md and FEATURE_MATRIX.md are updated to reflect the transition.
...
| Approach | Pros | Cons |
|----------|------|------|
| **Implementation-tracked non-release (chosen)** | Zero runtime cost; no new crate; Forgejo is the single source of truth | Requires manual or issue-driven refresh; cannot detect "live" stalls in real time |
...
| 7-day | Faster detection | Overhead of more frequent STATUS.md updates |
