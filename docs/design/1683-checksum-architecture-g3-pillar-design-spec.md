...
This document is the **canonical design specification** for issue #1683 covering
the G3 checksum architecture pillar.
...
**Decision:** Checksum is computed on ciphertext (after encryption).
