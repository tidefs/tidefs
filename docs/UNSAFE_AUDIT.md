...
| `apps/tidefs-posix-filesystem-adapter-daemon/src/lib.rs` | 681, 689, 699, 703, 711, 756 | block | FFI/syscall boundary in TideFS-owned code. | Locally documented by #1158 contract review. |
...
| `crates/tidefs-validation/src/mount_harness.rs` | 341, 378, 396, 415, 444, 461, 486, 490, 510, 559, 590, 603, 629, 641, 680, 697, 700, 755, 819, 938, 947 | block | POSIX/FUSE validation syscall harness or process-control helper. | Locally documented by #1158 contract review. |
...
| `crates/tidefs-validation/tests/fuse_locking.rs` | 44, 58, 74, 98, 181, 268, 271, 282, 288, 324, 327, 342, 348, 379, 382, 406, 412, 486, 489, 495, 501, 538, 544, 551, 558, 560, 572, 573, 579, 583, 593, 597, 604, 609, 627, 633, 659, 662, 676, 682, 763, 769, 776, 783, 785, 797, 798, 804, 808, 817, 821, 828, 833, 850, 856 | block, unsafe fn | POSIX/FUSE validation syscall harness or process-control helper. | Locally documented by #1158 contract review. |
