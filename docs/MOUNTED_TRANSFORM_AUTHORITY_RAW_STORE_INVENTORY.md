...
| `crates/tidefs-local-filesystem/src/lib.rs` | 65 | 63 mounted production matches, one pool-backed content-inspection diagnostic fallback, plus one in-file test raw drain assertion. |
