...
| `crates/tidefs-local-filesystem/src/lib.rs` | 65 | Mounted production, recovery, reclaim, capacity, a pool-backed content-inspection diagnostic fallback, and raw drain/test assertions that remain blocked or raw-only as classified below. |
