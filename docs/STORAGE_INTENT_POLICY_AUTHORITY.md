...
| #863 | Storage-intent fault validation matrix (P10-02 section 13) proves ack, placement, media, and WAN promises under typed faults and forbidden-outcome checks; rows bind #913 query snapshots, #915 objectives, and #920 result/refusal evidence. |
...
- `docs/FAULT_INJECTION_CHAOS_CORRUPTION_CAMPAIGNS_P10-02.md` (including
  ...
  legal outcomes, forbidden outcomes, recovery receipts, and gate artifacts; storage-intent rows additionally bind #913 query snapshots, #915 objectives, #920 result/refusal evidence, and the forbidden-outcome catalog from section 13.6.
