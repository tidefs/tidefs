...
| `crates/tidefs-relocation-governor` | `tidefs-relocation-governor` | `workspace-member` | `product-code` | planned authority surface for relocation governance; follow-up issue required for concrete dependency wiring and release claims. |
...
| `crates/tidefs-storage-intent-cost` | `tidefs-storage-intent-cost` | `workspace-member` | `product-code` | planned authority surface for storage intent cost model; follow-up issue required for concrete dependency wiring and release claims. |
...
| `crates/tidefs-storage-intent-workload-signals` | `tidefs-storage-intent-workload-signals` | `workspace-member` | `product-code` | planned authority surface for storage intent workload signals; follow-up issue required for concrete dependency wiring and release claims. |
