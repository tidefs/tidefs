...
| Counted set | Value |
| --- | ---: |
| Workspace packages | 155 |
| Explicitly excluded package roots | 5 |
| Discovered package manifests | 160 |
| Classified package roots | 160 |
...
| --- | --- | ---: | --- |
| `product` | `product-code`, `adapter-operator` | 134 | Shipped or planned-to-ship libraries, binaries, adapters, kernel surfaces, and operator entrypoints. |
